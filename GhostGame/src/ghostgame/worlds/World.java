	...
	public void render(Graphics g){
		...
		for(int y = yStart;y < yEnd;y++){
			for(int x = xStart;x < xEnd;x++){
				TileController tileController = new TileController(getTile(x, y), new TileView());
				tileController.render(g, (int) (x * Tile.TILEWIDTH - handler.getGameCamera().getxOffset()),
